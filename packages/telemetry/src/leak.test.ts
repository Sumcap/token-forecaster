...
const SECRET_PROMPT = [
  "Fix the importer in /Users/someone/Projects/token-forecaster/packages/core/src/schemas.ts.",
...
const FORBIDDEN = [
  "/Users/someone/Projects/token-forecaster/packages/core/src/schemas.ts",
